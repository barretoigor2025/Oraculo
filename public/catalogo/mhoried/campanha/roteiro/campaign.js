...
export const CENAS = {
  ...
  acampamento_elfico: {
    ...
    falaEntrada: '[Sem se levantar, voz baixa e medida, cada palavra escolhida.] Interessante. Humanos no acampamento dos Vhuureth — sem convite, e ainda assim respirando. [pausa longa] Nós, os Vhuureth, não gostamos de acasos. Então digam sem rodeio: o que querem?',
    ganchoPosBatalha: {
  ...
  dominio_wulfram: {
    ...
    falaEntrada: '[Imóvel, chifres inclinados; fala como quem escuta a floresta antes de responder.] A floresta sentiu vocês antes de eu ver. [silêncio longo, olha cada aventureiro] As árvores não gostam de pressa — nem eu. Falem: o que os Blackwoods têm que vocês querem tomar?',
    entradaBorda: 'norte',
    ato: 2,
  ...
  ruinas_piromante: {
    ...
    falaEntrada: '[Vira-se de supetão, uma chama já dançando entre os dedos.] Quem— não, não cheguem perto. Um passo e viram cinza, entenderam? [olhar saltando de um pra outro] Esta pedra é minha. Achei primeiro. [a chama cresce, depois hesita] Falem rápido o que querem... antes que minhas mãos decidam sozinhas.',
    entradaBorda: 'oeste',
    ato: 2,
  ...
  cnoc_na_rithe: {
    ...
    falaEntrada: '[Ergue os olhos das ervas, faca de cortar planta ainda na mão.] Por todos os galhos — estranhos no meu terreno. [avalia o grupo sem rodeio] Falem logo: vêm em paz ou vêm com problema? Uma coisa eu sirvo com chá; a outra, eu sirvo com a faca.',
    entradaBorda: 'leste',
    ato: 2,
  ...
  drowned_grove: {
    ...
    falaEntrada: 'Vocês chegaram... chegaram. [a superfície da água ondula sozinha] As águas sussurraram de vocês muito antes dos passos. De um de vocês, em especial... especial. [olha para um aventureiro específico] Sentem-se. O que a água guarda, a água cobra.',
    ganchoPosBatalha: {
      npc: 'npc_ruzalka',
  ...
  manticore_grounds: {
    ...
    falaEntrada: '[Mão no arco, não levanta.] Quietos. [olhos fixos nas sombras das árvores] Ela nos observa. [voz mais baixa] Um movimento errado, e acabou. [pausa longa] Ajudem. Por favor.',
    ganchoPosBatalha: {
      npc: 'npc_valmorien',
  ...
  kobolds_dissidentes: {
    ...
    falaEntrada: '[Dedo nos lábios, olhos no território kobold.] Psiu — baixem a voz. Krink não quer que Blunkin ouça. [avalia o grupo com rapidez] Vocês vêm por quê? Se é contra Blunkin, Krink ajuda — com informação. Krink não luta. Krink sobrevive.',
    entradaBorda: 'oeste',
    ato: 2,
